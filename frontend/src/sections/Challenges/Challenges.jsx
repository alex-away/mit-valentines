            ...
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                    <div className="bg-white p-10 rounded-2xl shadow-2xl">
                        ...
                        <p className="text-gray-600 mb-6 text-lg">
                            💘 Post a selfie with your match & tag us!
                        </p>
                        <button
                            onClick={handleAcceptChallenge}
                            className={`bg-pink-500 text-white px-8 py-3 rounded-full hover:bg-pink-600 transition text-lg ${
                ...
                <div className="mt-12 grid lg:grid-cols-2 gap-12">
                    <div className="bg-white p-10 rounded-2xl shadow-2xl">
                        ...
                        <p className="text-gray-600 mb-6 text-lg">
                            Enter your and your crush's name to see how
                            compatible you are!
                        </p>
                ...
                <div className="mt-12 grid lg:grid-cols-2 gap-12">
                    <div className="bg-white p-10 rounded-2xl shadow-2xl">
                        ...
                        <p className="text-gray-600 mb-6 text-lg">
                            Leave an anonymous sweet message on the Love Board!
                        </p>
                    ...
                    <div className="bg-white p-10 rounded-2xl shadow-2xl">
                        ...
                        <p className="text-gray-600 mb-6 text-lg">
                            Enter your favorite emojis to see if your match
                            vibes with you!
                        </p>
                ...
                <div className="mt-12 bg-white p-10 rounded-2xl shadow-2xl">
                    ...
                    <p className="text-gray-600 mb-6 text-lg">
                        Answer some random fun questions and get matched with a
                        mystery person!
                    </p>
