...
const Quiz = () => {
    ...
    const getResult = () => {
        ...
        const romanticScore = answers.filter((a) =>
            romanticAnswers.includes(a)
        ).length
        const adventurousScore = answers.filter((a) =>
            adventurousAnswers.includes(a)
        ).length

        if (romanticScore > adventurousScore)
            return "You are a Romantic Lover ❤️"
        if (adventurousScore > romanticScore)
            return "You are an Adventurous Lover 🌍"
